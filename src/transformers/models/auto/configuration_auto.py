...
CONFIG_MAPPING_NAMES = OrderedDict[str, str](
    [
        ...
        ("yoso", "YosoConfig"),
        ("youtu", "YoutuConfig"),
        ("youtu_vita", "YoutuVITAConfig"),
        ("qwen3_vita", "Qwen3VITAConfig"),
        ("mamba3_vita", "Mamba3VITAConfig"),
        ("mamba3_qwen3_vita", "Mamba3Qwen3VITAConfig"),
        ("zamba", "ZambaConfig"),
        ("zamba2", "Zamba2Config"),
...
MODEL_NAMES_MAPPING = OrderedDict[str, str](
    [
        ...
        ("yoso", "YOSO"),
        ("youtu", "Youtu"),
        ("youtu_vita", "Youtu-VITA"),
        ("qwen3_vita", "Qwen3-VITA"),
        ("mamba3_vita", "Mamba3-VITA"),
        ("mamba3_qwen3_vita", "Mamba3-Qwen3-VITA"),
        ("zamba", "Zamba"),
        ("zamba2", "Zamba2"),
        ("zoedepth", "ZoeDepth"),
    ]
